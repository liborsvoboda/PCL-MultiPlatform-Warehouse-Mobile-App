    ...
    public abstract class UdpSocketBase : UdpSendBase
    {
       ...
       // #endregion
        ...
        protected IPEndPoint UdpClientInitialize(
            ISocketLite.PCL.Interface.ICommunicationInterface communicationInterface,
            int port,
            bool allowMultipleBindToSamePort = false,
            bool isUdpMultiCast = false,
            IPAddress mcastAddress = null)
        {
            var ipLanAddress = (!string.IsNullOrWhiteSpace(communicationInterface.IpAddress)) ? IPAddress.Parse(communicationInterface.IpAddress) : IPAddress.Any;
